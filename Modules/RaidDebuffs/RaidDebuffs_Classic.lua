...
local function CreateWidgets()
    ...
    exportBtn:SetTexture("Interface\\AddOns\\Cell_Wrath\\Media\\Icons\\export.blp", {16, 16}, {"CENTER", 0, 0})
    ...
    importBtn:SetTexture("Interface\\AddOns\\Cell_Wrath\\Media\\Icons\\import.blp", {16, 16}, {"CENTER", 0, 0})
...
local function CreateInstanceFrame()
    ...
    instancesFrame:SetPoint("TOPLEFT", expansionDropdown, "BOTTOMLEFT", 0, -7)
...
local glowTypeText, glowTypeDropdown, glowTargetDropdown, glowOptionsFrame, glowConditionType, glowConditionOperator, glowConditionValue, glowColor, glowLines, glowParticles, glowFrequency, glowLength, glowThickness, glowScale
