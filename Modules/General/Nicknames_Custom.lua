...
local function CreateCustomNicknamesFrame()
    ...
    newItem.playerName.tip = newItem.playerName:CreateFontString(nil, "OVERLAY", "CELL_WRATH_FONT_WIDGET")
    ...
    newItem.nickname.tip = newItem.nickname:CreateFontString(nil, "OVERLAY", "CELL_WRATH_FONT_WIDGET")
    ...
    newItem.tip = newItem:CreateFontString(nil, "OVERLAY", "CELL_WRATH_FONT_WIDGET")
    ...
    customs[0]:SetTexture("Interface\\AddOns\\Cell_Wrath\\Media\\Icons\\new", {16, 16}, {"RIGHT", -1, 0})
...
LoadList = function()
    ...
    for i, v in ipairs(CellDB["nicknames"]["list"]) do
        if not customs[i] then
            ...
            -- nickname
            customs[i].nickname = customs[i]:CreateFontString(nil, "OVERLAY", "CELL_WRATH_FONT_WIDGET")
            ...
            -- customs[i].del:SetTexture("Interface\\AddOns\\Cell_Wrath\\Media\\Icons\\delete", {16, 16}, {"CENTER", 0, 0})
            ...
            -- customs[i].edit:SetTexture("Interface\\AddOns\\Cell_Wrath\\Media\\Icons\\info", {16, 16}, {"CENTER", 0, 0})
