...
L["CHANGELOGS"] = [[
    ...
    <p>*（熊猫人怀旧服）修复与武僧相关的问题。</p>
    <br/>

    <h1>r268-release (2025-10-30 11:15 GMT+8)</h1>
    <p>* 修复英文客户端的法术等级问题。</p>
    <p>* 修复“动作”指示器中可能存在的空值错误。</p>
    <p>* 更新本地化。</p>
    <br/>
    ...
    <p>* 修复血量文字指示器。</p>
    <p>*（正式服）新增延迟队伍类型检测，提升布局切换的可靠性。</p>
    <br/>

    <h1>r264-release (Oct 10, 2025, 11:50 GMT+8)</h1>
    <p>* 修复周年服的双天赋支持（#427，感谢 muffinhydra）。</p>
    <p>* 修复指示器加载问题。</p>
    <p>* 优化正式服的布局回退机制。</p>
    <p>* 更新怀旧服/巫妖王/大灾变的增益检查选项。</p>
    <br/>

    <h1>r263-beta (Sep 28, 2025, 14:10 GMT+8)</h1>
    <p>+ 为周年服添加了基础的双天赋支持（#416，感谢 muffinhydra）。</p>
    <p>* 重构布局可见性和指示器刷新逻辑。</p>
    <p>* 修复正式服的光环鼠标提示。</p>
    <p>* UI缩放变更时，像素刷新改为延迟处理。</p>
    <p>* 修复布局回退机制。</p>
    <p>- 移除正式服的 alwaysUpdateAuras。</p>
    <p>* 更新本地化。</p>
    <br/>
    ...
    <p>* 提升巫妖王怀旧服版本号到30405。</p>
    <br/>

    <h1>r256-release (Jul 8, 2025, 18:00 GMT+8)</h1>
    <p>*（熊猫人之谜）修复真言术：盾指示器。</p>
    <br/>

    <h1>r255-release (Jul 8, 2025, 16:00 GMT+8)</h1>
    <p>+ 为特别关注框体新增“治疗者”（#393 by hreich）。</p>
    <p>+（熊猫人之谜）真言术：盾指示器已回归。</p>
    <p>*（熊猫人之谜）修复灵魂石的点击施法。</p>
    <p>* 部分重写“增益检查”与“缺失增益”指示器，现在支持所有版本。</p>
    <p>-（经典旧世）移除了减益持续时间的显示限制。</p>
    <br/>

    <h1>r254-release (Jul 4, 2025, 21:20 GMT+8)</h1>
    <p>* 适配熊猫人之谜。由于游戏版本更新，布局自动切换与能量过滤已被重置。</p>
    <p>* 战斗中禁用拖动。</p>
    <p>* 增益检查已更新：现在仅支持正式服和熊猫人之谜。</p>
    <p>- 移除“缺失增益”指示器。</p>
    <p>+（正式服）在战斗中掉线重登后会尝试恢复正确的布局。</p>
    <br/>
    ...
    <p>* 更新地心之战第二赛季的流血列表 (#359)。</p>
    <p>* 更新织雾默认法术列表 (#364)。</p>
    <p>* 修复导入时缺失的能量条过滤。</p>
    <p>* 修复边框指示器。</p>
    <p>* 修复指示器法术列表的高度。</p>
    <p>* 修复国服巫妖王3.4.4版本的问题。</p>
    <p>* 特别关注框体的“坦克”现已支持怀旧服。</p>
    <p>- 移除深渊探索进度检查。</p>
    <p>+ 添加 Cell_ExpansionDataOverrides。</p>
    <br/>
...
L["OLDER_CHANGELOGS"] = [[
    ...
    <p>* 修复创建自定义颜色指示器时存在的问题。</p>
    <p>* 更新繁中。</p>
    <br/>

    <h1>r208-release (Dec 14, 2023, 00:43 GMT+8)</h1>
    <p>* 现在可以通过拖拽改变点击施法条目的顺序了。</p>
    <p>* 修复快速协助的点击施法功能。</p>
    <br/>
    ...
    <p>+ 正式服新工具：快速协助。感谢 钛锬(NGA) 测试并提供爆发法术列表。</p>
    <p>* 更新副本减益。</p>
    <p>* 更新 Cell.GetUnitFrame。</p>
    <p>* 更新正式服萨满的驱散检查。</p>
    <p>+ 为状态文字指示器添加了“显示背景”和“显示计时器”的选项。</p>
    <p>* 更新本地化。</p>
    <p>* 修复异常。</p>
    <br/>
    ...
    <p>+ 添加对“信号系统”的支持（正式服）。</p>
    <p>* 扩充“特别关注框体”按钮的数量到10个。</p>
    <p>+ 为自定义图标指示器添加了“显示层数文本”的选项。</p>
    <p>* 为“特别关注框体”和“快捷施法”添加了 OmniCD 的支持，但需要等其作者发布更新。</p>
    <p>* 修复几个异常。</p>
    <br/>
